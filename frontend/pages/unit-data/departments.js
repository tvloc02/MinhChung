        ...
        >
            <div className="space-y-6">
                ...
                <div className="flex justify-between items-center">
                    <div>
                        <h1 className="text-2xl font-bold text-gray-900">Quản lý Bộ môn/Ngành</h1>
                        <p className="text-gray-600 mt-1">Quản lý thông tin các bộ môn và ngành học</p>
                    </div>
